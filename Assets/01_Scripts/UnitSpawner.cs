...
public class UnitSpawner : NetworkBehaviour
{
    ...
    [SerializeField] private Button _human_ArcherSpawnButton;

    [SerializeField] private NetworkPrefabRef _human_WarriorPrefab;
    [SerializeField] private NetworkPrefabRef _human_ArcherPrefab;

    [Header("Devil")]
    [SerializeField] private Button _devil_WarriorSpawnButton;
    [SerializeField] private Button _devil_ArcherSpawnButton;

    [SerializeField] private NetworkPrefabRef _devil_WarriorPrefab;
    [SerializeField] private NetworkPrefabRef _devil_ArcherPrefab;
    ...
    private void Awake()
    {
        ...
        _human_ArcherSpawnButton.onClick.AddListener(SpawnHumanArcherUnit);

        _devil_WarriorSpawnButton.onClick.AddListener(SpawnDevilWarriorUnit);
        _devil_ArcherSpawnButton.onClick.AddListener(SpawnDevilArcherUnit);
    ...
    private void SpawnHumanArcherUnit() // using Button
    {
        Runner.Spawn(_human_ArcherPrefab, new Vector3(-5f, 0f, 0f), Quaternion.Euler(0f, 0f, 0f));
    }
    ...
    private void SpawnDevilArcherUnit() // using Button
    {
        Runner.Spawn(_devil_ArcherPrefab, new Vector3(5f, 0f, 0f), Quaternion.Euler(0f, 0f, 0f));
    }
}
